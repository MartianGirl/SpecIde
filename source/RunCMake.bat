...
cmake -DCMAKE_BUILD_TYPE=%BUILD% -DCMAKE_INSTALL_PREFIX=%CD% -G"MinGW Makefiles" .
goto END

:MS32
set CMAKE_PREFIX_PATH=C:\libs\SFML\x86;C:\libs\zlib\x86
cmake -DCMAKE_BUILD_TYPE=%BUILD% -DCMAKE_INSTALL_PREFIX=%CD% -G"Visual Studio 16 2019" -AWin32 .
goto END

:MS64
set CMAKE_PREFIX_PATH=C:\libs\SFML\x64;C:\libs\zlib\x64
cmake -DCMAKE_BUILD_TYPE=%BUILD% -DCMAKE_INSTALL_PREFIX=%CD% -G"Visual Studio 16 2019" -Ax64 .
goto END

:NINJAGNU
set MINGW_SYSROOT=C:\MinGW
set CMAKE_PREFIX_PATH=C:\libs\MinGW\SFML-2.5.1
cmake -DCMAKE_BUILD_TYPE=%BUILD% -DCMAKE_INSTALL_PREFIX=%CD% -G "Ninja" .
goto END

:NINJAMS32
set CMAKE_PREFIX_PATH=C:\libs\SFML\x86;C:\libs\zlib\x86
cmake -DCMAKE_BUILD_TYPE=%BUILD% -DCMAKE_INSTALL_PREFIX=%CD% -DCMAKE_C_COMPILER=cl -DCMAKE_CXX_COMPILER=cl -G "Ninja" .
goto END
