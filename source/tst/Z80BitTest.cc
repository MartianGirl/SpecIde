...
BOOST_AUTO_TEST_CASE(rlc_r_test)
{
    ...
    z80.af.b.l = 0x00;
    runCycles(z80, m, 7);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x01);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x00);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x02);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x00);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x04);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x00);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x08);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x08);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x10);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x00);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x20);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x20);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x40);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x00);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x80);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x80);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x01);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x01);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x02);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x00);
}
...
BOOST_AUTO_TEST_CASE(rl_r_test)
{
    ...
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x80);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x00);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x45);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x01);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x00);
}
...
BOOST_AUTO_TEST_CASE(rrc_r_test)
{
    ...
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x80);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x81);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x40);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x00);
    runCycles(z80, m, 8);
...
BOOST_AUTO_TEST_CASE(sla_r_test)
{
    ...
    z80.af.b.l = 0x00;
    runCycles(z80, m, 7);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0xFF);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x00);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0xFE);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0xA9);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0xFC);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0xAD);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0xF8);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0xA9);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0xF0);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0xA5);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0xE0);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0xA1);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0xC0);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x85);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x80);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x81);
    runCycles(z80, m, 8);
    ...
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x00);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x44);
}
...
BOOST_AUTO_TEST_CASE(sll_r_test)
{
    ...
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x00);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x03);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x04);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x07);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x00);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x0F);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x0C);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x1F);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x08);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x3F);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x2C);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x7F);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x28);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0xFF);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0xAC);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0xFF);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0xAD);
}
...
BOOST_AUTO_TEST_CASE(sra_r_test)
{
    ...
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0xC0);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x84);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0xE0);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0xA0);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0xF0);
...
BOOST_AUTO_TEST_CASE(srl_r_test)
{
    ...
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x7F);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x29);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x3F);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x2D);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x1F);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x09);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x0F);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x0D);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x07);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x01);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x03);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x05);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.bc.b.h, 0x01);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x01);
    runCycles(z80, m, 8);
...
BOOST_AUTO_TEST_CASE(bit_manipulation_reg_test)
{
    ...
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x30);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x18);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x74);
    runCycles(z80, m, 8);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x74);
}
...
BOOST_AUTO_TEST_CASE(bit_manipulation_ptrhl_test)
{
    ...
    runCycles(z80, m, 12);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x7C);
    runCycles(z80, m, 12);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x38);
    runCycles(z80, m, 12);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x7C);
    runCycles(z80, m, 12);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x38);
    ...
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x7C);
    runCycles(z80, m, 12);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0xB8);
}
...
BOOST_AUTO_TEST_CASE(bit_manipulation_ptriy)
{
    ...
    runCycles(z80, m, 20);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x5C);
    runCycles(z80, m, 20);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x18);
    runCycles(z80, m, 20);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x5C);
    ...
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x5C);
    runCycles(z80, m, 20);
    BOOST_CHECK_EQUAL(z80.af.b.l, 0x98);
